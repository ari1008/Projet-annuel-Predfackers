<script>
    function showProduct(category, mark,id="<?= $_SESSION["id"];?>") {
        ...
        let url = "http://three.local/Projet-annuel-Predfackers/public/everyone.php?p=product&category="+category+"&mark="+mark+"&id="+id;
        console.log(url);
